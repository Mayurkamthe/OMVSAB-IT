    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href="tel:+919999999999" className="text-sm font-medium text-gray-600 hover:text-primary transition-colors whitespace-nowrap">
            +91 99999 99999
          </a>
          <a
            href="#contact"
      ...
      <div className={`lg:hidden bg-white border-t border-gray-100 overflow-hidden transition-all duration-300 ${menuOpen ? "max-h-96" : "max-h-0"}`}>
        <div className="px-4 sm:px-6 py-4 space-y-1">
          ...
          <div className="pt-3 flex flex-col gap-2">
            <a href="tel:+919999999999" className="text-sm font-medium text-gray-600 hover:text-primary text-center py-2">
              +91 99999 99999
            </a>
            <a
              href="#contact"
